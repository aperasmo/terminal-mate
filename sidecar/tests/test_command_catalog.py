...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("can you check current cost forecast", "aws ce get-cost-forecast"),
        ("check current cost forecast", "aws ce get-cost-forecast"),
        ("Show my AWS identity.", "aws sts get-caller-identity"),
        ("my AWS identity", "aws sts get-caller-identity"),
        ("List AWS EC2 instances.", "aws ec2 describe-instances"),
